...
create table keystore (id identity not null, label varchar(255), source integer not null, walletModel integer not null, masterFingerprint varchar(8), derivationPath varchar(255) not null, extendedPublicKey varchar(255), mwebScanPrivateKey binary(32), mwebSpendPublicKey binary(33), masterPrivateExtendedKey bigint, seed bigint, wallet bigint not null, index integer not null);
